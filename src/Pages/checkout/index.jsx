...
const Checkout = () => {
  ...
  // ~~~~~~~~~ States ~~~~~~~~~~~//
  const [firstName, setFirstName] = useState('22')
  const [lastName, setLastName] = useState('22')
  const [email, setEmail] = useState('22')
  const [adress, setAdress] = useState('22')
  const [phone, setPhone] = useState('22')
  const [postalCode, setPostalCode] = useState('22')
  const [country, setCountry] = useState('22')
  const [region, setRegion] = useState('22')
  // ~~~~~~ Credit Card information ~~~~~~//

  const [cardNumber, setCardNumber] = useState('22')
  const [fullName, setFullName] = useState('22')
  const [month, setMonth] = useState('22')
  const [year, setYear] = useState('22')
  const [cardCvv, setCardCvv] = useState('22')
  const id = uuidv4()
